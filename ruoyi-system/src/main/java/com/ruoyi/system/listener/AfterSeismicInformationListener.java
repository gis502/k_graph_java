...
public class AfterSeismicInformationListener implements ReadListener<AfterSeismicInformation> {
    ...
    public AfterSeismicInformationListener(AfterSeismicInformationMapper afterSeismicInformationMapper,
                                              int totalRows,
                                              String userName) {
    ...
    @Override
    public void invoke(AfterSeismicInformation data, AnalysisContext analysisContext) {
