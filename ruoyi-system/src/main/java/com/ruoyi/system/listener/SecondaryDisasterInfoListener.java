...
public class SecondaryDisasterInfoListener implements ReadListener<SecondaryDisasterInfo> {

    private final List<SecondaryDisasterInfo> list = new ArrayList<SecondaryDisasterInfo>();
    private SecondaryDisasterInfoMapper secondaryDisasterInfoMapper;
    private int totalRows;
    private int currentRow = 0;
    private String userName;
    private boolean stopReading = false;
    public SecondaryDisasterInfoListener(SecondaryDisasterInfoMapper secondaryDisasterInfoMapper,
                                         int totalRows,
                                         String userName) {
        this.secondaryDisasterInfoMapper = secondaryDisasterInfoMapper;
    ...
    @Override
    public void invoke(SecondaryDisasterInfo data, AnalysisContext analysisContext) {
    ...
    public List<SecondaryDisasterInfo> getList() {
        return list;
    }
}
