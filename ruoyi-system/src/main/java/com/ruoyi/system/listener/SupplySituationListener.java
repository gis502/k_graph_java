...
public class SupplySituationListener implements ReadListener<SupplySituation> {
    ...
    public SupplySituationListener(SupplySituationMapper supplySituationMapper,
                                        int totalRows,
                                        String userName) {
        this.supplySituationMapper = supplySituationMapper;
    ...
    @Override
    public void invoke(SupplySituation data, AnalysisContext analysisContext) {
