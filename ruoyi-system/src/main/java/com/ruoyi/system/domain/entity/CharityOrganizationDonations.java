...
@Data
@TableName("charity_organization_donations")
public class CharityOrganizationDonations {
    ...
    @ExcelProperty(value = {"慈善组织接收捐赠资金", "地震时间"})
    ...
    @ExcelProperty(value = {"慈善组织接收捐赠资金", "震区（县/区）"})
    @ColumnWidth(30)
    @ContentStyle(horizontalAlignment = HorizontalAlignmentEnum.LEFT) // 设置为左对齐
