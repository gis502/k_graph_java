...
public class AfterSeismicInformationServiceImpl extends
    ...
    public List<AfterSeismicInformation> importAfterSeismicInformation(MultipartFile file, String userName, String eqId) throws IOException {
        ...
        AfterSeismicInformationListener listener = new AfterSeismicInformationListener(baseMapper, totalRows, userName);
        // 读取Excel文件，从第4行开始
    ...
    public IPage getPage(RequestBTO requestBTO) {
        ...
        LambdaQueryWrapper<AfterSeismicInformation> queryWrapper =
                Wrappers.lambdaQuery(AfterSeismicInformation.class).like(AfterSeismicInformation::getEarthquakeIdentifier, requestParam);
        return page(afterSeismicInformationPage, queryWrapper);
    }
