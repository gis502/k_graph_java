...
public class EqListServiceImpl extends ServiceImpl<EqListMapper, EqList> implements IEqListService {
    ...
    private static final String PYTHON_API_URL = "http://81.70.200.28:5000/process";  // Python 服务 URL
    private static final String LISTENER_URL = "http://81.70.200.28:5000/auto_fetch_earthquake_data";
...
//        System.out.println("✅ 图谱构建完成：" + eqName);
    ...
    public void trigger(TriggerDTO triggerDTO) {
        ...
        // 请求 trigger 接口
        String triggerUrl = "http://assessment.free.idcfengye.com/api/open/eq/trigger";
        ...
        while(true){
            ...
            // 获取从库最新的一条数据
            String currentlyUrl = "http://assessment.free.idcfengye.com/api/open/eq/currently";
